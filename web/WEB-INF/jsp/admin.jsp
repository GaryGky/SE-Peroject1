...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-3 column">
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/jumpToadd">新增书籍</a>
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/allbook">显示图书馆全部书籍
            </a>
        </div>
        ...
        <div class="col-md-4 column">
            <form action="${pageContext.request.contextPath}/book/queryBook" class="form-inline" method="post"
                  style="float: right">
                    <span style="color: red;font-weight:
                                            bold">${error}</span>
                <input type="text" class="form-control" placeholder="请输入要查询的书籍" name="queryBookName" required>
