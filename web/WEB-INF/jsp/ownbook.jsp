        ...
        <div class="col-md-5 column">
            <form
                    ...
                    <span style="color: red;font-weight:
                                        bold">${error}</span>
                <input type="text" class="form-control" placeholder="请输入要查询的学号"
                       name="stu_id">
        ...
        <div class="col-md-4 column">
            <form action="${pageContext.request.contextPath}/book/queryBook"
                  ...
                  style="float: right">
                    <span style="color: red;font-weight:
                                        bold">${error}</span>
                <input type="text" class="form-control" placeholder="请输入要查询的书籍"
                       name="queryBookName">
                ...
                <c:forEach var="book" items="${requestScope.get('list')}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-primary"
                               href="${pageContext.request.contextPath}/stu/returnbook?book_id=${book.getBook_id()}&stu_id=${stu_id}">还书</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
